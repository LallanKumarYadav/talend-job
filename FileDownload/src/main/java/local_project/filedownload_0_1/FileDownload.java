...
package local_project.filedownload_0_1;
...
/**
 * Job: FileDownload Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class FileDownload implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "FileDownload";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(FileDownload.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
String foo = "bar";
  ...
  String fromFile = "http://samplecsvs.s3.amazonaws.com/Sacramentorealestatetransactions.csv";
        String toFile = "/data/ffff.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final FileDownload FileDownloadClass = new FileDownload();

        int exitCode = FileDownloadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = FileDownload.class.getClassLoader().getResourceAsStream("local_project/filedownload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = FileDownload.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : FileDownload");
        }
...
/************************************************************************************************
 *     28245 characters generated by Talend Open Studio for Data Integration 
 *     on the August 2, 2019 4:33:50 PM EDT
 ************************************************************************************************/